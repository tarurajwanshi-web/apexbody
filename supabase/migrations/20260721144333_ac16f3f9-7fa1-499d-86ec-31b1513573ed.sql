...
ALTER TABLE public.nutrition_weekly_reviews ADD CONSTRAINT nutrition_weekly_reviews_flag_chk
  CHECK (flag_reason IS NULL OR flag_reason = ANY (ARRAY[
    ...
    'invalid_goal_value','missing_target_rate','deficit_caution_override','fuel_more_override',
    'target_reached','at_safe_minimum_not_deficit','abnormal_weight_swing','stale_weight_used',
    'recomp_maintenance_phase'
  ]));